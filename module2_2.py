...
first = input('First int:')
second = input('Second int:')
third = input('Third int:')

# Ваша задача написать условную конструкцию (из if, 1
# elif, else), которая выводит кол-во одинаковых чисел среди 3-х введённых.
